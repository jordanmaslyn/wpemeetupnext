...
export const generatedSchema = {
  ACF_GoogleMap: {
    ...
    countryShort: { __type: "String" },
    latitude: { __type: "Float" },
    longitude: { __type: "Float" },
    placeId: { __type: "String" },
    postCode: { __type: "String" },
    state: { __type: "String" },
    stateShort: { __type: "String" },
    streetAddress: { __type: "String" },
    streetName: { __type: "String" },
    streetNumber: { __type: "String" },
    zoom: { __type: "String" },
  },
  AcfFieldGroup: {
    __typename: { __type: "String!" },
  ...
  User: {
    ...
    meetupInfo: { __type: "User_Meetupinfo" },
    name: { __type: "String" },
    nicename: { __type: "String" },
    nickname: { __type: "String" },
    pages: {
 ...
 * Google Map field
 */
export interface ACF_GoogleMap {
   ...
   */
  countryShort?: Maybe<ScalarsEnums["String"]>;
  /**
   ...
   * The country associated with the map
   */
  placeId?: Maybe<ScalarsEnums["String"]>;
  /**
   ...
   */
  stateShort?: Maybe<ScalarsEnums["String"]>;
  /**
   ...
   */
  streetName?: Maybe<ScalarsEnums["String"]>;
  /**
   * The street number associated with the map
   */
  streetNumber?: Maybe<ScalarsEnums["String"]>;
  /**
   * The zoom defined with the map
   */
  zoom?: Maybe<ScalarsEnums["String"]>;
}
...
export interface User {
  ...
  /**
   * Added to the GraphQL Schema because the ACF Field Group &quot;Meetup Info&quot; was set to Show in GraphQL.
   */
  meetupInfo?: Maybe<User_Meetupinfo>;
  /**
 ...
 * Field Group
 */
export interface User_Meetupinfo {
  __typename?: "User_Meetupinfo";
  /**
   * Not required, this will be available to your fellow WP Engine co-workers. Work email is perfectly okay.
   */
  email?: Maybe<ScalarsEnums["String"]>;
   ...
   */
  fieldGroupName?: Maybe<ScalarsEnums["String"]>;
  location?: Maybe<ACF_GoogleMap>;
  /**
   * Not required, provide only if you&#039;re comfortable doing so. Please include international country code.
   */
...
export interface SchemaObjectTypes {
  ...
  User_Meetupinfo: User_Meetupinfo;
